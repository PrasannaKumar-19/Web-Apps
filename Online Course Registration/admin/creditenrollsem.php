...
{
$sql=mysqli_query($bd, "SELECT * FROM  courseenrolls where department='".$_POST['department']."' && semester='".$_POST['semester']."' && batch='".$_POST['batch']."' ");
...
header("location:enrollhistorysem.php");
}
else
{
